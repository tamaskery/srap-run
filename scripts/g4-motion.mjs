...
const context=await browser.newContext({viewport:{width:1920,height:1080},recordVideo:{dir:'evidence/g4/video',size:{width:1920,height:1080}}});
...
try{
 ...
 await page.waitForTimeout(2200);await page.screenshot({path:'evidence/g4/pavilion-travel.png'});
 await page.waitForTimeout(2000);await page.screenshot({path:'evidence/g4/pavilion-cutaway.png'});
 ...
 await page.waitForTimeout(200);await page.screenshot({path:'evidence/g4/actors-close.png'});
}finally{
 await context.close();await page.video().saveAs('evidence/g4/slice-motion.webm');

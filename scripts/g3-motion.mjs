...
const context=await browser.newContext({viewport:{width:1920,height:1080},recordVideo:{dir:'evidence/g3/video',size:{width:1920,height:1080}}});
...
try{
 ...
 await page.waitForTimeout(200);await page.screenshot({path:'evidence/g3/actors-close.png'});
}finally{
 await context.close();await page.video().saveAs('evidence/g3/slice-motion.webm');

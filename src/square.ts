...
// elongated pedestrian square, southern supermarket, northern pavilions,
// central Fókák landmark, western gardens; adjoining roads are background.
...
export const SQUARE_SCENE: SceneDefinition = {
  ...
  walls: [
    ...
    { id: 'west-pavilion', x: 14, z: 5, width: 11, depth: 8, height: 3.2, shape: 'ellipse', color: '#958e7c', cutaway: 'pavilions', cutawayBaseHeight: .8 },
    { id: 'north-pavilion', x: 26, z: 6, width: 9, depth: 7, height: 3.2, shape: 'ellipse', color: '#958e7c', cutaway: 'north-pavilion', cutawayBaseHeight: .8 },
    { id: 'south-pavilion', x: 16, z: 14, width: 12, depth: 7, height: 3.2, shape: 'ellipse', color: '#958e7c', cutaway: 'south-pavilion', cutawayBaseHeight: .8 },
    ...
    { id: 'east-garden', x: -22, z: -3, width: 8, depth: 5, height: 1.8, shape: 'ellipse', color: '#687b57' },
    { id: 'east-grove', x: -23, z: 9, width: 6, depth: 8, height: 2, shape: 'ellipse', color: '#687b57' },
    { id: 'north-hedge', x: -9, z: -9, width: 20, depth: 1.2, height: 1.7, color: '#65775a' },
  ...
  roofs: [
    ...
    { id: 'west-canopy', x: 14, z: 5, width: 12, depth: 9, height: 3.4, shape: 'ellipse', color: '#dedbd0', cutaway: 'pavilions' },
    { id: 'north-canopy', x: 26, z: 6, width: 10, depth: 8, height: 3.4, shape: 'ellipse', color: '#dedbd0', cutaway: 'north-pavilion' },
    { id: 'south-canopy', x: 16, z: 14, width: 13, depth: 8, height: 3.4, shape: 'ellipse', color: '#dedbd0', cutaway: 'south-pavilion' },
  ],
  zones: [
    { id: 'west-shelter', kind: 'hiding', x: -30, z: 4, width: 3, depth: 4, label: 'PLANTER SHELTER' },
    { id: 'garden-shelter', kind: 'hiding', x: -9, z: -7.5, width: 4, depth: 3, label: 'HEDGE SHELTER' },
    ...
    { id: 'pavilion-cutaway', kind: 'cutaway', x: 14, z: 7, width: 15, depth: 14, group: 'pavilions' },
    { id: 'north-pavilion-cutaway', kind: 'cutaway', x: 26, z: 8, width: 13, depth: 14, group: 'north-pavilion' },
    { id: 'south-pavilion-cutaway', kind: 'cutaway', x: 16, z: 16, width: 16, depth: 9, group: 'south-pavilion' },
  ],
  items: [
  ...
  labels: [
    ...
    { text: 'PAVILIONS', point: { x: 16, y: 3.5, z: 14 } },
